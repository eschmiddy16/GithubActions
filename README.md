[![Run App EthanSchmidt](https://github.com/eschmiddy16/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/eschmiddy16/GithubActions/actions/workflows/run-app.yaml)
